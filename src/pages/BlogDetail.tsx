        ...
        <div className="screen-max-size mx-auto">
          ...
          <div className="mt-6 gap-8 flex flex-col lg:mt-[52px] lg:gap-[52px]">
            ...
            <div className="flex flex-col-reverse lg:flex-row lg:gap-8 lg:items-start">
              <div
                className="lg:w-[320px] lg:border-grey lg:p-6 lg:rounded-xl lg:sticky top-4"
                data-aos="fade-right"
                data-aos-delay="500"
              >
                <div className="left flex flex-col gap-8 w-full lg:gap-6">
                  ...
                  <div className="gap-6 flex flex-col md:grid grid-cols-3 lg:flex lg:flex-col lg:gap-4">
                    {listArticles.map((value, index) => (
                      <>
                        <div
                          className="flex gap-4 flex-col lg:flex-row lg:gap-3 lg:items-center"
                          key={index}
                        >
                          <img
                            src={value.img}
                          ...
                          />
                          <h2 className="eh text-black-01 lg:par-2 lg:font-medium xl:par-1-16 lg:font-medium">
                            {value.title}
                          </h2>
                        </div>
                      </>
              ...
              <div className="right flex-1" data-aos="fade">
