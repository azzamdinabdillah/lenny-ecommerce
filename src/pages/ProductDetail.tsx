          ...
          <div className="flex gap-6 flex-col">
            <div className="flex gap-6 flex-col md:flex-row">
              ...
              <div className="flex gap-6 flex-col">
                ...
                <div className="gap-4 flex flex-col mt-2 md:flex-row">
            ...
            <div className="flex gap-6 flex-col md:flex-row">
              ...
              <div className="gap-4 flex flex-col mt-2 flex-1">
            ...
            <div className="gap-6 flex flex-col">
              <div className="gap-4 flex flex-col">
                ...
                <div className="border-grey p-4 flex flex-col gap-6 md:flex-row md:items-start">
