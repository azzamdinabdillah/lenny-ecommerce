...
export function ModalSignIn({ setOpenSignIn }: { setOpenSignIn: Function }) {
  return (
    <>
      <div
        className="vh-100 vw-100 bg-black-01/50 flex justify-center items-center fixed top-0 left-0 right-0 bottom-0 z-30 p-6"
        onClick={(e) => {
          console.log(e.target.classList);
        }}
      >
        <div className="bg-white py-8 px-6 flex flex-col gap-[34px] rounded-lg border-grey shadow-lg w-[327px] md:max-w-[440px] md:w-full">
